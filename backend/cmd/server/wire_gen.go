...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	adminSubscriptionHandler := handler.ProvideAdminSubscriptionHandler(subscriptionService, client)
	...
	globalPlanService := handler.ProvideGlobalPlanService(client)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, modelPricingHandler, availableChannelHandler, asyncImageHandler, batchImageHandler, consoleHandler, idempotencyCoordinator, idempotencyCleanupService)
