...
func (tx *Tx) init() {
	...
	tx.CreemProductBinding = NewCreemProductBindingClient(tx.config)
	tx.CreemRefundEvent = NewCreemRefundEventClient(tx.config)
	...
	tx.UserGlobalPlanSubscription = NewUserGlobalPlanSubscriptionClient(tx.config)
