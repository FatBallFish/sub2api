...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			creemproductbinding.Table:           creemproductbinding.ValidColumn,
			creemrefundevent.Table:              creemrefundevent.ValidColumn,
			...
			userglobalplansubscription.Table:    userglobalplansubscription.ValidColumn,
