...
func (_q *SubscriptionPlanQuery) QueryGlobalPlanSubscriptions() *UserGlobalPlanSubscriptionQuery {
...
func (_q *SubscriptionPlanQuery) WithGlobalPlanSubscriptions(opts ...func(*UserGlobalPlanSubscriptionQuery)) *SubscriptionPlanQuery {
	query := (&UserGlobalPlanSubscriptionClient{config: _q.config}).Query()
...
func (_q *SubscriptionPlanQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*SubscriptionPlan, error) {
	...
	if query := _q.withGlobalPlanSubscriptions; query != nil {
		if err := _q.loadGlobalPlanSubscriptions(ctx, query, nodes,
			func(n *SubscriptionPlan) { n.Edges.GlobalPlanSubscriptions = []*UserGlobalPlanSubscription{} },
			func(n *SubscriptionPlan, e *UserGlobalPlanSubscription) {
...
func (_q *SubscriptionPlanQuery) loadGlobalPlanSubscriptions(ctx context.Context, query *UserGlobalPlanSubscriptionQuery, nodes []*SubscriptionPlan, init func(*SubscriptionPlan), assign func(*SubscriptionPlan, *UserGlobalPlanSubscription)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(userglobalplansubscription.FieldPlanID)
	}
	query.Where(predicate.UserGlobalPlanSubscription(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(subscriptionplan.GlobalPlanSubscriptionsColumn), fks...))
	}))
