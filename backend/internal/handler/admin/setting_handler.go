...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		AffiliateInviterSignupReward:                           settings.AffiliateInviterSignupReward,
		AffiliateInviterSignupRewardCap:                        settings.AffiliateInviterSignupRewardCap,
		AffiliateInviteeSignupReward:                           settings.AffiliateInviteeSignupReward,
		RegionBlockEnabled:                                     settings.RegionBlockEnabled,
		RegionBlockFrontendEnabled:                             settings.RegionBlockFrontendEnabled,
		RegionBlockAPIEnabled:                                  settings.RegionBlockAPIEnabled,
		RegionBlockCodes:                                       settings.RegionBlockCodes,
		RegionBlockHeaders:                                     settings.RegionBlockHeaders,
		...
		PaymentCurrencyExchangeRates:                           paymentCfg.CurrencyExchangeRates,
