...
func TestNormalizeVisibleMethodSource(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "alipay jeepay alias", method: payment.TypeAlipay, input: "jeepay", want: VisibleMethodSourceJeepayAlipay},
		...
		{name: "wxpay jeepay alias", method: payment.TypeWxpay, input: "jeepay", want: VisibleMethodSourceJeepayWechat},
...
func TestVisibleMethodProviderKeyForSource(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "jeepay alipay", method: payment.TypeAlipay, source: VisibleMethodSourceJeepayAlipay, want: payment.TypeJeepay, ok: true},
		...
		{name: "jeepay wechat", method: payment.TypeWxpay, source: VisibleMethodSourceJeepayWechat, want: payment.TypeJeepay, ok: true},
