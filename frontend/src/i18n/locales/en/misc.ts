export default {
  ...
  payment: {
    ...
    admin: {
      ...
      global_planOrder: 'Global Plan',
      global_plan_upgradeOrder: 'Global Plan Upgrade',
      paidAt: 'Paid At',
      ...
      deductSubscriptionEntitlement: 'Deduct subscription entitlement',
      deductSubscriptionEntitlementHint: 'Calculate refundable amount from remaining duration and remaining quota',
      ...
      quotaPerPeriodUsd: 'Period Quota (USD)',
      monthlyMaxUsd: 'Monthly Max (USD)',
      planCategory: 'Plan Category',
      planCategoryPlaceholder: 'default',
      applicableGroupMode: 'Applicable Groups',
      applicableGroupModeHint: 'Whitelist and blacklist are mutually exclusive. All groups are covered when unrestricted.',
      applicableGroupModeAll: 'Unrestricted',
      applicableGroupModeWhitelist: 'Whitelist only',
      applicableGroupModeBlacklist: 'Exclude blacklist',
      publicBadge: 'Public Badge',
      publicBadgePlaceholder: 'Best Value',
      day: 'Day',
      week: 'Week',
      month: 'Month',
      globalPlanQuotaRequired: 'Global plan quota must be greater than 0',
