    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          inviterSignupReward: 'Inviter Signup Reward',
          inviterSignupRewardDesc: 'Balance rewarded to the inviter after an invitee registers. 0 = disabled.',
          inviterSignupRewardCap: 'Inviter Signup Reward Cap',
          inviterSignupRewardCapDesc: 'Maximum cumulative signup reward for one inviter. 0 = unlimited.',
          inviteeSignupReward: 'Invitee Signup Reward',
          inviteeSignupRewardDesc: 'Balance rewarded to a new user who registers with an invite code. 0 = disabled.',
          customUsers: {
        ...
        regionBlock: {
          title: 'Region Access Control',
          description: 'Restrict frontend or API access based on country/region headers in the request.',
          enabled: 'Enable region block',
          enabledHint: 'When enabled, requests are checked against the region settings below.',
          frontendEnabled: 'Block frontend access',
          frontendEnabledHint: 'Block frontend pages for restricted regions.',
          apiEnabled: 'Block API access',
          apiEnabledHint: 'Block API calls for restricted regions.',
          codes: 'Restricted region codes',
          codesHint: 'Comma-separated ISO country/region codes, for example CN,IR.',
          headers: 'Region detection headers',
          headersHint: 'Headers read in order to determine country/region, for example CF-IPCountry.'
        },
      },
      ...
      payment: {
        ...
        currencyExchangeRates: 'Payment Currency Rates',
        currencyExchangeRatesHint: 'Converts billing amounts into payment method currencies. Format: USD:CNY=7.20,CNY:USD=0.13888889. Orders keep the rate snapshot from creation time.',
        ...
        providerJeepay: 'Jeepay',
		providerCreem: 'Creem',
        jeepayGuideSummary: 'Jeepay uses the unified order API. Configure the gateway URL, app ID, and merchant private key.',
        jeepayGuideNote: 'Make sure the Jeepay callback URL is publicly reachable and matches the notify URL configured in Jeepay.',
        visibleAlipaySource: 'Alipay display source',
        visibleWxpaySource: 'WeChat Pay display source',
        visibleMethodEnabled: 'Show to users',
        visibleMethodSourceHint: 'Controls which payment entry is shown to users. Actual availability still depends on provider configuration and enabled status.',
        ...
        field_applePay: 'Apple Pay',
        field_googlePay: 'Google Pay',
        ...
        field_stripeWalletHint: 'auto displays the wallet when card payments are enabled and the device, browser, and Stripe account are eligible; never always hides it.',
		...
		creemWebhookHint: 'Configure the following URL as the Webhook endpoint in Creem Dashboard:',
