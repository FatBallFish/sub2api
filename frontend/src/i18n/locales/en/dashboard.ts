export default {
  ...
  usage: {
    ...
    remainingBalanceCredits: 'Remaining Balance Credits',
    remainingSubscriptionCredits: 'Remaining Subscription Credits',
    remainingTotalCredits: 'Remaining Total Credits',
    currentInventory: 'Current inventory',
    currentWindowOnly: 'Current window only',
    balancePlusSubscription: 'Balance + subscription',
    resetNow: 'Now',
  ...
  redeem: {
    ...
    balanceAddedAffiliateInviterSignup: 'Balance Added (Inviter Signup Reward)',
    balanceAddedAffiliateInviteeSignup: 'Balance Added (Invitee Signup Reward)',
