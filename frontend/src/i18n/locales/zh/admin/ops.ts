export default {
    ops: {
      ...
      runtime: {
        ...
        ttftP99MaxMsHint: 'TTFT P99超过此值时显示为红色（默认：500ms）',
        requestErrorRateMaxPercent: '请求错误率最大百分比',
        requestErrorRateMaxPercentHint: '请求错误率超过此值时显示为红色（默认：5%）',
        upstreamErrorRateMaxPercent: '上游错误率最大百分比',
        upstreamErrorRateMaxPercentHint: '上游错误率超过此值时显示为红色（默认：5%）',
        silencing: {
          title: '告警静默（维护模式）',
          enabled: '启用静默',
