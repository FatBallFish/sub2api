    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          inviterSignupReward: '邀请人注册奖励',
          inviterSignupRewardDesc: '被邀请用户完成注册后，发放给邀请人的奖励余额。0 = 不发放。',
          inviterSignupRewardCap: '邀请人注册奖励上限',
          inviterSignupRewardCapDesc: '同一邀请人可获得的注册奖励累计上限。0 = 不限制。',
          inviteeSignupReward: '被邀请人注册奖励',
          inviteeSignupRewardDesc: '新用户使用邀请码注册后获得的奖励余额。0 = 不发放。',
          customUsers: {
            title: '专属用户配置',
        ...
        regionBlock: {
          title: '地区访问限制',
          description: '根据请求中的国家/地区头限制前端或 API 访问。',
          enabled: '启用地区限制',
          enabledHint: '开启后将按下方配置判断请求来源地区。',
          frontendEnabled: '限制前端访问',
          frontendEnabledHint: '命中受限地区时阻止访问前端页面。',
          apiEnabled: '限制 API 访问',
          apiEnabledHint: '命中受限地区时阻止调用 API。',
          codes: '受限地区代码',
          codesHint: '逗号分隔的 ISO 国家/地区代码，例如 CN,IR。',
          headers: '地区识别请求头',
          headersHint: '按顺序读取这些请求头来识别国家/地区，例如 CF-IPCountry。'
        },
      },
      ...
      payment: {
        ...
        currencyExchangeRates: '支付币种汇率',
        currencyExchangeRatesHint: '用于将计费金额换算到支付渠道币种，格式：USD:CNY=7.20,CNY:USD=0.13888889。订单会保存创建时的汇率快照。',
        orderTimeout: '订单超时时间',
		...
		providerCreem: 'Creem',
        jeepayGuideSummary: 'Jeepay 使用统一下单接口，需配置网关地址、应用 ID 和商户私钥。',
        jeepayGuideNote: '请确认 Jeepay 回调地址可被公网访问，并在 Jeepay 后台配置相同的通知地址。',
        visibleAlipaySource: '支付宝展示来源',
        visibleWxpaySource: '微信支付展示来源',
        visibleMethodEnabled: '在用户端展示',
        visibleMethodSourceHint: '用于控制用户端展示哪个支付入口；实际可用性仍取决于服务商配置和启用状态。',
        typeDisabled: '类型已禁用',
        ...
        field_stripeWalletHint: 'auto 会在银行卡支付已启用且当前设备、浏览器和 Stripe 账户符合条件时显示；never 始终隐藏。',
		...
		creemWebhookHint: '请在 Creem Dashboard 中将以下地址配置为 Webhook 端点：',
