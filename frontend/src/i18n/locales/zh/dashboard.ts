export default {
  ...
  usage: {
    ...
    userBilled: '用户扣费',
    accountBilled: '账号计费',
    remainingBalanceCredits: '余额剩余额度',
    remainingSubscriptionCredits: '订阅剩余额度',
    remainingTotalCredits: '总剩余额度',
    currentInventory: '当前库存',
    currentWindowOnly: '仅当前窗口',
    balancePlusSubscription: '余额 + 订阅',
    resetNow: '现在',
    resetPending: '待刷新',
  ...
  redeem: {
    ...
    balanceAddedAffiliateInviterSignup: '余额充值（邀请人注册奖励）',
    balanceAddedAffiliateInviteeSignup: '余额充值（被邀请人注册奖励）',
