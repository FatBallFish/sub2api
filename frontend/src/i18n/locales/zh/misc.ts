export default {
  ...
  payment: {
    ...
    admin: {
      ...
      global_planOrder: '全局套餐',
      global_plan_upgradeOrder: '全局套餐升级',
      paidAt: '支付时间',
      completedAt: '完成时间',
      expiresAt: '过期时间',
      feeRate: '手续费率',
      ...
      deductSubscriptionEntitlement: '扣除套餐权益',
      deductSubscriptionEntitlementHint: '按剩余时长与剩余额度自动计算可退金额',
      userBalance: '用户余额',
      orderAmount: '订单金额',
      ...
      groupPlan: '分组套餐',
      quotaPeriod: '配额周期',
      quotaPerPeriodUsd: '周期配额（USD）',
      monthlyMaxUsd: '月度上限（USD）',
      planCategory: '套餐类目',
      planCategoryPlaceholder: 'default',
      applicableGroupMode: '适用分组范围',
      applicableGroupModeHint: '白名单和黑名单互斥；不限制时表示对所有分组生效。',
      applicableGroupModeAll: '不限制',
      applicableGroupModeWhitelist: '仅白名单分组生效',
      applicableGroupModeBlacklist: '排除黑名单分组',
      publicBadge: '公开标签',
      publicBadgePlaceholder: '最划算',
      day: '天',
      week: '周',
      month: '月',
      globalPlanQuotaRequired: '全局套餐配额必须大于 0',
      originalPrice: '原价',
      price: '价格',
      currency: '币种标注',
